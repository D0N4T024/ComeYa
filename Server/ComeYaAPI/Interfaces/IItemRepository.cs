...
namespace ComeYaAPI.Interfaces
{
    public interface IItemRepository: IRepository<Item>
    {
        ...
        Task<EntityListResult<ReadItemDTO>> GetAllItems(List<string>? types, List<string>? category, decimal price, int page,ulong combo, int restaurant, int rand, decimal pageSize, int marketingImg);
